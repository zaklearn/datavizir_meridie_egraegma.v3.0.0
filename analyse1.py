        ...
        try:
            ...
            with col2:
                if st.button(t.get("export_word", "📄 Export to Word")):
                    try:
                        doc = create_word_report(df_filtered, stats_summary, selected_columns, t, language)
...
def create_word_report(df_filtered, stats_summary, selected_columns, t, language):
    """
